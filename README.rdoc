...
* Single access token: Use this for a private feed or API access. Ex: www.example.com?user_credentials=[single access token]. Grants access but does NOT persist.
